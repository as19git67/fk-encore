...
_BASE_FIELDS = {
    ...
    "title": "Rechnung von Dr. med. Ulrich Hölzenbein",
    "doc_date": "2019-04-01",
    "sender": "Dr. med. Ulrich Hölzenbein",
    "document_number": "4498",
...
_REQUEST = {
    "text": "Rechnung 01.04.19 ... geb. 08.06.1967",
...
def test_implausible_tax_year_is_dropped_not_fatal(bad_year):
    ...
    assert body["document_number"] == "4498"
