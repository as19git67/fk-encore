...
- **Web-UI vereinheitlichen** (Seitenskelett `PageLayout`, Untermenü-Zeile im Sticky-Stack, Toolbar-Vertrag, Scroll-/Fokus-Restore, Selection-Bar und Basket): Issue #1272, Konzept und Etappen in `.claude/plans/web-ui-vereinheitlichung.md`.
