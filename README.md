...
| `llm_service`        | Python – local Llama classifier + multilingual-e5 text embeddings (documents + finance); model swappable at runtime under Dokumente → Einstellungen → KI-Modell, see [`llm-service/README.md`](./llm-service/README.md#switching-models-at-runtime) |
